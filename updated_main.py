...
parser.add_argument('--kl_constraint', type=float, default=0.01, metavar='G',
                    help='KL divergence constraint for TRPO updates (default: 0.01)')
...
# Agent
agent = TRPO_SAC(env.observation_space.shape[0], env.action_space, args)
